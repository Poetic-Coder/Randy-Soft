...
app.use(session({
    secret: 'rghw8u5tqvb374rbw7ecr2374trmcnw34854356234.,;/55=-*-+-*/79++20-*/po5ithjgfjuytrjhgfdaszdxcfvb',
    saveUninitialized: false, //if set to true, this session will be saved on the server on eachrequest
    //no matter if something changed or not.
    resave: false,
